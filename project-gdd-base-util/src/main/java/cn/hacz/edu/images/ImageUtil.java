...
public class ImageUtil {
	 ...
	 *             IO异常。
	 */
	public static void writeImage(final BufferedImage bufferedImage, final OutputStream output, final String formatName)
			throws IOException {
		ImageIO.write(bufferedImage, formatName, output);
	}
	 ...
	 *             IO异常。
	 */
	public static void writeImage(final byte[] imageBytes, final OutputStream output, final String formatName)
			throws IOException {
		BufferedImage image = byteToImage(imageBytes);
